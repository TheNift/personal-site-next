					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							skills: [
								...
								{ '@type': 'Skill', name: 'Full-Stack Development', alternateName: 'Fullstack Development' },
								...
								{ '@type': 'Skill', name: 'Linux', alternateName: 'Arch Linux, Ubuntu, Manjaro' },
								{ '@type': 'Skill', name: 'MacOS', alternateName: 'macOS' },
								{ '@type': 'Skill', name: 'Windows', alternateName: 'Windows 10, Windows 11' },
								...
								{ '@type': 'Skill', name: 'Teamwork', alternateName: 'Communication, Leadership, Collaboration' },
								{ '@type': 'Skill', name: 'Problem Solving', alternateName: 'Problem Solving, Critical Thinking' },
								{ '@type': 'Skill', name: 'Adaptability', alternateName: 'Adaptability, Flexibility' },
								{ '@type': 'Skill', name: 'Time Management', alternateName: 'Time Management, Prioritization' },
								{ '@type': 'Skill', name: 'Agile Development', alternateName: 'Agile Methodologies, Scrum' },
							],
							alumniOf: {
